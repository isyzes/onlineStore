...
public class StoreController {
    ...
    public String getListProduct(HttpServletRequest request, Model model,
        ...
        addAttributeFilter(model, brand, colour, sizeProduct);
    ...
    public String search(
        ...
        Page<Product> products = productService.searchProduct(search, brand, colour, sizeProduct, page);
        addAttribute(model, user, products, request);
        return "women";
    }
    ...
    private void addAttributeFilter(Model model, Set<String> brand, Set<Colour> colour, Set<Size> sizeProduct) {
        if (sizeProduct != null)

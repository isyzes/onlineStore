...
<div class="container">
	...
	<div class="head-t">
		<div class="logo">
			<a href="index.jsp"><img src="${pageContext.request.contextPath}/src/main/webapp/resources/images/logo.png" class="img-responsive" alt=""/> </a>
		</div>
		<!-- start header_right -->
		<div class="header_right">
			...
			<div class="cart box_1">
				<a href="checkout.jsp">
					<h3> <span class="simpleCart_total">$0.00</span> (<span id="simpleCart_quantity" class="simpleCart_quantity">0</span> items)<img src="${pageContext.request.contextPath}/resources/images/bag.png" alt=""></h3>
				</a>	
		...
		<ul class="megamenu skyblue">
			...
			<li class="grid"><a class="color2" href="/women">new arrivals</a>
				<div class="megapanel">
					<div class="row">
						...
						<c:forEach items="${categories}" var="i">
							<div class="col1">
								<div class="h_nav">
									<h4><c:out value="${i}"/></h4>
									<ul>
										<c:forEach items="${i.listSection}" var="section">
			...
			<c:forEach items="${categories}" var="item">
				<li class="grid"><a class="color6" href="/women"><c:out value="${item}"/></a>
					<div class="megapanel">
						<div class="row">
							<div class="col1">
								<div class="h_nav">
									<ul>
										<c:forEach items="${item.listSection}" var="section" >
											<li><a href="/women"><c:out value="${section}"/></a></li>
										</c:forEach>
									</ul>
								</div>
							</div>

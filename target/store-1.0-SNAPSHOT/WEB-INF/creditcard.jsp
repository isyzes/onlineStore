        ...
        <form action="/creditcard" method="post">
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" id="inputEmail4" placeholder="0000 0000 0000 0000" name="cardNumber" value="${user.creditCards.cardNumber}">
                </div>
                <div class="form-group col-md-6">
                    <label for="inputPassword4">Name here: </label>
                    <input type="text" class="form-control" id="inputPassword4" placeholder="CARD HOLDER" name="holder" value="${user.creditCards.holder}">
                </div>
            </div>

            <div class="form-group col-md-2">
                <label for="inputZip1">MM/YY</label>
                <input type="text" class="form-control" id="inputZip1" placeholder="EXPIRES" name="expires" value="${user.creditCards.expires}">
            </div>
            <div class="form-group col-md-2">
                <label for="inputZip2">CVV</label>
                <input type="text" class="form-control" id="inputZip2" placeholder="000" name="cvv" value="${user.creditCards.cvv}">
            </div>
